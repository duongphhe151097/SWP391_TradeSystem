...
public class AdminCategoryController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            List<CategoryEntity> SetCategories = categoryRepository
                    .getCategoriesWithPaging(startPage, endPage);
            req.setAttribute("VIEW_PAGING", new ViewPaging<>(SetCategories, pagination));
