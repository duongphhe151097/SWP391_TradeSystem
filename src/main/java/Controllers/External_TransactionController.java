...
@WebServlet(name = "External_TransactionController", urlPatterns = {"/external_Transaction"})
@Authorization(role = "", isPublic = true)
public class External_TransactionController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Retrieve external transactions from the repository
        List<UserEntity> externalTransactions = transactionManagerRepository.getExternalTransaction();

        // Set the list of transactions as an attribute in the request object
        req.setAttribute("externalTransactions", externalTransactions);
