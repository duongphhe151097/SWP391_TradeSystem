...
<head>
    ...
    <link rel="stylesheet" href="<c:out value="${pageContext.request.contextPath}/css/profile.css"/>">
    <title>Thông tin người dùng</title>
</head>
<body>
<jsp:include page="../common/header.jsp"/>
<div class="vh-100 d-flex justify-content-center align-items-center">
    <div class="col-md-6 p-5 shadow rounded-3">
        <div class="profile col-md-12">
            <div class="mb-2 d-flex flex-column justify-content-between align-content-center">
