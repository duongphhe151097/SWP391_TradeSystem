                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="input-group mb-3 d-flex flex-column">
                                ...
                                <select class="custom-select w-100" id="status" name="f_status">
                                    ...
                                    <option value="ALL" <c:if test="${filter.equals(ALL)}">selected</c:if>>Tất cả
                                    </option>
                                    <option value="0" <c:if test="${filter.equals(PENDING)}">selected</c:if>>Chưa kích
                                        hoạt
                                    </option>
                                    <option value="1" <c:if test="${filter.equals(ACTIVE)}">selected</c:if>>Đang hoạt
                                        động
                                    </option>
                                    <option value="2" <c:if test="${filter.equals(LOCKED)}">selected</c:if>>Đang bị
                                        khóa
                                    </option>
                                    <option value="3" <c:if test="${filter.equals(BANNED)}">selected</c:if>>Đã bị chặn
                                    </option>
                                </select>
                            </div>
                            <div class="input-group mb-3 d-flex flex-column">
