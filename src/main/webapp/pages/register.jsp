                ...
                <form action="<c:url value="/register"/>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${requestScope.USERNAME_ERROR != null}">
                            <small id="usernameHelp"
                                   class="form-text text-muted error-message">${requestScope.USERNAME_ERROR}</small>
                        </c:if>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${requestScope.PASSWORD_ERROR != null}">
                            <small id="passwordHelp"
                                   class="form-text text-muted error-message">${requestScope.PASSWORD_ERROR}</small>
                        </c:if>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${requestScope.REPASSWORD_ERROR != null}">
                            <small id="repasswordHelp"
                                   class="form-text text-muted error-message">${requestScope.REPASSWORD_ERROR}</small>
                        </c:if>
                    </div>
