            ...
            <form action="register" method="post">
                <div class="form-group">
                    ...
                    <c:if test="${requestScope.FULLNAME_ERROR != null}">
                        <small id="nameHelp" class="form-text text-muted">${requestScope.FULLNAME_ERROR}</small>
                    </c:if>
                ...
                <div class="form-group">
                    ...
                    <c:if test="${requestScope.EMAIL_ERROR != null}">
                        <small id="emailHelp" class="form-text text-muted">${requestScope.EMAIL_ERROR}</small>
                    </c:if>
                </div>
                ...
                <div class="form-group">
                    ...
                    <c:if test="${requestScope.USERNAME_ERROR != null}">
                        <small id="usernameHelp" class="form-text text-muted">${requestScope.USERNAME_ERROR}</small>
                    </c:if>
                </div>
                ...
                <div class="form-group">
                    ...
                    <c:if test="${requestScope.PASSWORD_ERROR != null}">
                        <small id="passwordHelp" class="form-text text-muted">${requestScope.PASSWORD_ERROR}</small>
                    </c:if>
                </div>
                ...
                <div class="form-group">
                    ...
                    <c:if test="${requestScope.REPASSWORD_ERROR != null}">
                        <small id="repasswordHelp" class="form-text text-muted">${requestScope.REPASSWORD_ERROR}</small>
                    </c:if>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-row">
                        <small class="form-text text-muted">${requestScope.CAPTCHA_ERROR}</small>
                    </div>
                </div>
                <c:if test="${requestScope.SUCCESS_MESSAGE != null || requestScope.FAILED_MESSAGE != null}">
                    <div class="form-group">
                        ...
                        <c:if test="${requestScope.FAILED_MESSAGE != null}">
                            <p>${requestScope.FAILED_MESSAGE}</p>
                        </c:if>
                    </div>
                </c:if>
