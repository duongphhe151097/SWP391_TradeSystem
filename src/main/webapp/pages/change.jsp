            ...
            <div class="col-md-5 p-5 shadow rounded-3">
                <div class="form-bloat">
                    <div class="mb-2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="logo">
                            <img src="<c:url value="/img/logo.png"/>" alt="Trade System Logo"
                    ...
                    <form action="<c:url value="/change"/>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="newPasswordInput"
                                   placeholder="Nhập mật khẩu mới (ít nhất 8 kí tự)" name="newPassword" required>
                        </div>

                        <div class="form-group">
                            <label for="reNewPasswordInput">Nhập lại mật khẩu mới</label>
                            <input type="password" class="form-control" id="reNewPasswordInput"
                                   placeholder="Nhập lại mật khẩu mới" name="reNewPassword" required>
                        </div>
